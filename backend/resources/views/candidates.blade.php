            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="candidate-card position-relative overflow-hidden text-center shadow rounded p-4">
                        ...
                        <div class="content">
                            <img src="{{ asset('images/team/01.jpg') }}" class="avatar avatar-md-md rounded-pill shadow-md" alt="">

                            <div class="mt-3">
                                <a href="#" class="title h5 text-dark">Steven Townsend</a>
                                <p class="text-muted mt-1">Marketing Director</p>
                            ...
                            <div class="mt-3">
                                <a href="#" class="btn btn-sm btn-primary me-1">View Profile</a>
                                <a href="{{ url('/contact') }}" class="btn btn-sm btn-icon btn-soft-primary"><i data-feather="message-circle" class="icons"></i></a>
                            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="candidate-card position-relative overflow-hidden text-center shadow rounded p-4">
                        <div class="content">
                            ...
                            <div class="mt-3">
                                <a href="#" class="title h5 text-dark">Tiffany Betancourt</a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="candidate-card position-relative overflow-hidden text-center shadow rounded p-4">
                        <div class="content">
                            ...
                            <div class="mt-3">
                                <a href="#" class="title h5 text-dark">Jacqueline Burns</a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="candidate-card position-relative overflow-hidden text-center shadow rounded p-4">
                        ...
                        <div class="content">
                            ...
                            <div class="mt-3">
                                <a href="#" class="title h5 text-dark">Mari Harrington</a>
                ...
                <!-- Repeat for more candidates... (similar structure) -->
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="candidate-card position-relative overflow-hidden text-center shadow rounded p-4">
                        <div class="content">
                            ...
                            <div class="mt-3">
                                <a href="#" class="title h5 text-dark">Floyd Glasgow</a>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="candidate-card position-relative overflow-hidden text-center shadow rounded p-4">
                        <div class="content">
                            <img src="{{ asset('images/team/06.jpg') }}" class="avatar avatar-md-md rounded-pill shadow-md" alt="">

                            <div class="mt-3">
                                <a href="#" class="title h5 text-dark">Donna Schultz</a>
                                <p class="text-muted mt-1">Web Designer / Developer</p>
