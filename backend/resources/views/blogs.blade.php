    ...
    <section class="section">
        <div class="container">
            <div class="row g-4">
                    ...
                    <div class="card blog blog-primary shadow rounded overflow-hidden border-0">
                        ...
                        <div class="card-body blog-content position-relative p-0">
                            ...
                            <div class="p-4">
                                ...
                                <a href="{{ route('blog.detail') }}" class="title fw-semibold fs-5 text-dark">11 Tips to Help You Get New Clients Through Cold Calling</a>
                                <ul class="list-unstyled d-flex justify-content-between align-items-center text-muted mb-0 mt-3">
                                    <li class="list-inline-item me-2"><a href="{{ route('blog.detail') }}" class="btn btn-link primary text-dark">Read Now <i class="mdi mdi-arrow-right"></i></a></li>
                    ...
                    <div class="card blog blog-primary shadow rounded overflow-hidden border-0">
                        ...
                        <div class="card-body blog-content position-relative p-0">
                            ...
                            <div class="p-4">
                                ...
                                <a href="{{ route('blog.detail') }}" class="title fw-semibold fs-5 text-dark">DigitalOcean launches first Canadian data centre in Toronto</a>
                                <ul class="list-unstyled d-flex justify-content-between align-items-center text-muted mb-0 mt-3">
                                    <li class="list-inline-item me-2"><a href="{{ route('blog.detail') }}" class="btn btn-link primary text-dark">Read Now <i class="mdi mdi-arrow-right"></i></a></li>
                    ...
                    <div class="card blog blog-primary shadow rounded overflow-hidden border-0">
                        ...
                        <div class="card-body blog-content position-relative p-0">
                            ...
                            <div class="p-4">
                                ...
                                <a href="{{ route('blog.detail') }}" class="title fw-semibold fs-5 text-dark">Using Banner Stands To Increase Trade Show Traffic</a>
                                <ul class="list-unstyled d-flex justify-content-between align-items-center text-muted mb-0 mt-3">
                                    <li class="list-inline-item me-2"><a href="{{ route('blog.detail') }}" class="btn btn-link primary text-dark">Read Now <i class="mdi mdi-arrow-right"></i></a></li>
                ...
                <!-- Repeat for other blog posts... (similar structure) -->
                <div class="col-lg-4 col-md-6">
                    <div class="card blog blog-primary shadow rounded overflow-hidden border-0">
                        <div class="card-img blog-image position-relative overflow-hidden rounded-0">
                            <div class="position-relative overflow-hidden">
